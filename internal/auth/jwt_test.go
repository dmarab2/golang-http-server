...
var testString = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJjaGlycHkiLCJzdWIiOiI5MmJhNTM1MC1hMjA5LTRlOTMtYjNlMi05NDYwNjA4NDliYjAiLCJleHAiOjE3NzAyMzQ4MDUsImlhdCI6MTc3MDIzNDgwNX0.w6MAxfsTxfXmUTxEERm6rBdGR1fGcBhS6ffnIkxubWA"
...
func TestValidateJWTAlone(t *testing.T) {
	testUUID, err := ValidateJWT(testString, testSecretKey)
	fmt.Printf("Test UUID is %s\n", testUUID)
	if err != nil {
		t.Errorf("Error, there shouldn't be one. Error was %v", err)
	}
}
